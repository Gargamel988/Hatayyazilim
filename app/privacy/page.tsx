...
export const metadata: Metadata = {
    title: "Gizlilik Politikası | Veri Kullanımı ve Güvenlik",
    description: "Hatay Yazılım gizlilik politikası, çerez kullanımı, veri toplama ve kullanıcı hakları hakkında detaylı bilgiler. Web sitemizde toplanan bilgilerin korunması.",
    keywords: [
        "Gizlilik Politikası",
        "Privacy Policy",
        "Veri Güvenliği",
