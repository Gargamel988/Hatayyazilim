            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm text-white/60">Hizmetlerimiz</span>
                    </motion.div>
                    ...
                    >
                        Web, mobil ve dijital sistemler geliştiriyoruz.
                        Her projeye <span className="text-white/70">uzun vadeli bir altyapı</span> olarak yaklaşıyor,
                        ölçeklenebilir çözümler üretiyoruz.
                    </motion.p>
                </motion.div>
            </div>
        </section>
